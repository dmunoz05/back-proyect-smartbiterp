...
import { getMoneyTotal, getMoneyMonth, getExpenseMonth, getBudgetTotal, getRecentTransactions } from '../controllers/dashboard.controller.js';
...
import { getComparisonByDate, getComparisonAll, getTotalComparison } from '../controllers/comparison.controller.js';
...
export const routes = () => {
    ...
    // Comparison
    router.get('/g/comparison/all', getComparisonAll);
